...
-- Total Votes 
#Creating a temporary table to attach player names to IDs
...
-- Rolling Tables
# Temp Table to connect player names to player IDs
...
; # Envy had the highest round average with 3.889 points per round, while Farhan had the lowest average with 0 points per round
